...
declare -a ics_versions=(3.19.18 3.19.19 3.19.22 3.23.12) # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-cp-common-services/index.yaml
declare -a ics_cases=(1.15.18 1.15.19 1.15.22 1.19.12)
