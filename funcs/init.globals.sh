...
declare -a gi_versions=(3.3.5) # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-guardium-insights/index.yaml
declare -a gi_cases=(2.3.5)
declare -a ics_versions=(3.19.22) # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-cp-common-services/index.yaml
declare -a ics_cases=(1.15.22)
