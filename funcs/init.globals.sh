...
declare -a fedora_supp_releases=(39) # list supported Fedora releases
declare -a gi_versions=(3.5.0) # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-guardium-insights/index.yaml
declare -a gi_cases=(2.5.0)
declare -a ics_versions=(4.9.0) # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-cp-common-services/index.yaml
declare -a ics_cases=(4.9.0)
declare -a bundled_in_gi_ics_versions=(0)
declare -a ocp_versions=(1)
declare -a ocp_major_versions=(4.14)
declare -a ocp_supported_by_gi=(0)
declare -a ocp_supported_by_ics=(0:1)
declare -a ocp_supported_by_cp4s=(0)
declare -a ocp_supported_by_edr=(0)
declare -a gi_sizes=(small)
...
ibm_pak_version=1.15.1 # https://github.com/IBM/ibm-pak
...
cp4s_channel="1.10"
cp4s_versions=("1.10.22") # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-cp-security/index.yaml
cp4s_cases=("1.0.47")
cp4s_case_name="ibm-cp-security"
cp4s_case_inventory_setup="ibmSecurityOperatorSetup"

edr_case_name="ibm-security-edr"
edr_cases=("1.0.8") # https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-security-edr/index.yaml
edr_versions=("1.0.0") 
